...
В случае необходимости запуска регламентного процесса на различных версиях или параллельно, financial_request → request_process_context может быть реализована в виде 1:M, тогда в context необходимо будет добавить version: int и parent_id: int
